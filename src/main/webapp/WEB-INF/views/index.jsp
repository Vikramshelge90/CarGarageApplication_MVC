							...
							<div class="collapse navbar-collapse" id="navbarsExample04">
                              ...
                              <li class="nav-item">
                                 <a class="nav-link" href="contact.html">Contact Us</a>
									...
									<li class="nav-item dropdown d_none"><a
										class="nav-link dropdown-toggle" href="#" id="loginDropdown"
										role="button" data-toggle="dropdown" aria-haspopup="true"
										aria-expanded="false"> <i
											class="fa fa-user-circle padd_right" aria-hidden="true"></i>Login/Register
									</a>
				...
				<div class="col-md-10 offset-md-1">
					<div class="row">
						<div class="col-md-6 margin_bottom">
							...
							<div class="work_text">
								<h3>
									Quick repair<br> <span class="blu">Total Service</span>
								</h3>
							</div>
						</div>
						<div class="col-md-6 margin_bottom">
					...
					<div class="col-md-8">
						<ul class="location_icon">
							<li><a href="#"><i class="fa fa-map-marker"></i></a>
								Locations</li>
							<li><a href="#"><i class="fa fa-phone"></i></a> +71
								9087654321</li>
							<li><a href="#"><i class="fa fa-envelope"></i></a>gogarage1@gmail.com</li>
						</ul>
					</div>
					<div class="col-md-6">
			...
			<div class="copyright">
				<p>
					© 2024 All Rights Reserved. Design by <a
						href="https://html.design/">Gogarage Automobs</a>
				</p>
			</div>
		</div>
	</footer>
